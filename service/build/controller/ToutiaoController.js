...
var toutiaoDetailAnalyzer_1 = require("../utils/toutiaoDetailAnalyzer");
...
var ToutiaoController = /** @class */ (function () {
    ...
    ToutiaoController.prototype.pullData = function (req, res) {
        ...
        var analyzer = toutiaoAnalyzer_1.ToutiaoAnalyzer.getInstance();
    ...
    ToutiaoController.prototype.pullDetail = function (req, res) {
        var groupId = req.params.groupId;
        var fileName = 'toutiao_detail';
        var url = "https://www.toutiao.com/group/" + groupId + "/";
        console.log(url);
        var analyzer = toutiaoDetailAnalyzer_1.ToutiaoDetailAnalyzer.getInstance();
        new crowller_1.Crowller(url, fileName, analyzer);
        console.log('Pulled new data from toutiao_detail website');
        res.json(util_1.getResponseData(true));
    };
    ToutiaoController.prototype.getDetail = function (req, res) {
        try {
            var groupId = req.params.groupId;
            var filePath = path_1.default.resolve(__dirname, '../../data/toutiao_detail.json');
            var result = fs_1.default.readFileSync(filePath, 'utf-8');
            var json = JSON.parse(result);
            res.json(util_1.getResponseData(json[groupId]));
        }
        catch (error) {
            res.send(util_1.getResponseData(false, '没有数据'));
        }
    ...
    __decorate([
        decorator_1.get('/pull/detail/:groupId'),
        decorator_1.use(util_1.checkLogin),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", void 0)
    ], ToutiaoController.prototype, "pullDetail", null);
    __decorate([
        decorator_1.get('/detail/:groupId'),
        decorator_1.use(util_1.checkLogin),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", void 0)
    ], ToutiaoController.prototype, "getDetail", null);
